...
export default function AddSaleOrder() {
  ...
  const [tabs, setTabs] = useState([{ id: 1, title: "Sales Order #1" }]);
  ...
  const onSubmit = async (data) => {
    ...
    const saleOrderData = {
      ...
      sales_order_date: currentTab.purchase_order_date,
      ...
      sales_order_details: currentTab.rows
  ...
  return (
    <div>
      <PageTitle title="Add Sale Order" />
